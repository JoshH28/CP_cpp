...
void solve() {
    ll n, qn, t1, t2; cin >> n >> qn;
    string str, type; cin >> str;
    ll state[n+10], cnt[n+10];
    // if (n <= 100 && qn <= 100) {
    //     string query; ll t1, t2;
    //     for (ll q = 0; q < qn; q++) {
    //         cin >> query;
    //         if (query == "toggle") {
    //             cin >> t1;
    //             if (state[t1]) state[t1] = 0;
    //             else state[t1] = 1;
    //         } else {
    //             cin >> t1 >> t2;
    //             for (ll q = 0; q < qn; q++) {
