    ...
    pll qry(ll left, ll right) {
        ...
        if (left == start && right == end) {
            ...
            if (left > mid) {
                ...
                if (l->qry(left, mid) < r->qry(mid+1, right)) {
                    return r->qry(mid+1, right);
                } else {
                    return l->qry(left, mid);
                }
                //return max(, r->qry(mid+1, right));
            }
        }
    }
} *root;
